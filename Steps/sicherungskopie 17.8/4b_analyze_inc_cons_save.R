...
#Fallunterscheidung nicht anspruchsberechtigt funktioniert nicht, daher durchführung in Stata
#write_dta(evs13, paste0("./Output/Daten/EVS2013_Hilfskonstrukt.dta"))
#write_dta(evs18, paste0("./Output/Daten/EVS2018_Hilfskonstrukt.dta"))

#hilfsweise Stata code ausführen in Datei "Datensatzbearbeitungen_Stata.do"

# Laden der EVS 2013 und Umwandlung in tibble()
#evs13 <- read_dta( "./Output/Daten/EVS2013_Hilfskonstrukt.dta")
#evs18 <- read_dta( "./Output/Daten/EVS2018_Hilfskonstrukt.dta")
...
HH_konsum <- evs13 %>% 
  ...
  summarise(`2013 absolut` = round(wtd.mean(EF89/3, EF107), digits=1), 
            `2013 Konsumquote` = round(wtd.mean(consum_share, EF107),digits=1))
...
HH_konsum$`2018 Konsumquote` <- evs18 %>% 
    ...
    mutate(consum_share = EF89/EF62*100) %>% 
    summarise(`2018 absolut` = round(wtd.mean(EF89/3, EF107), digits=1), 
              `2018 Konsumquote` = round(wtd.mean(consum_share, EF107),digits=1)) %>%
...
HH_save <- evs13 %>% 
  ...
  summarise(`2013 absolut` = round(wtd.mean(EF105/3, EF107), digits=1), 
            `2013 Sparquote` = round(wtd.mean(save_share, EF107),digits=1))
...
HH_save$`2018 absolut` <- evs18 %>% 
  ...
  summarise(`2018 absolut` = round(wtd.mean(EF105/3, EF107), digits=1), 
            `2018 Sparquote` = round(wtd.mean(save_share, EF107),digits=1)) %>%
  pull(`2018 absolut`)
...
#Die beiden größten Ausgabenblöcke 

# Konsum Nahrungsmittel EF73

HH_konsum_EF73 <- evs13 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF73/EF89*100) %>% 
  summarise(`2013 absolut` = round(wtd.mean(EF73/3, EF107), digits=1), 
            `2013 Konsumquote` = round(wtd.mean(consum_share, EF107),digits=1))
HH_konsum_EF73$`2018 absolut` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF73/EF89*100) %>% 
  summarise(`2018 absolut` = round(wtd.mean(EF73/3, EF107), digits=1), 
            `2018 Konsumquote` = round(wtd.mean(consum_share, EF107))) %>%
  pull(`2018 absolut`)
HH_konsum_EF73$`2018 Konsumquote` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
...
HH_konsum_EF76 <- evs13 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF76/EF89*100) %>% 
  summarise(`2013 absolut` = round(wtd.mean(EF76/3, EF107), digits=1), 
            `2013 Konsumquote` = round(wtd.mean(consum_share, EF107),digits=1))
HH_konsum_EF76$`2018 absolut` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF76/EF89*100) %>% 
  summarise(`2018 absolut` = round(wtd.mean(EF76/3, EF107), digits=1), 
            `2018 Konsumquote` = round(wtd.mean(consum_share, EF107))) %>%
  pull(`2018 absolut`)
HH_konsum_EF76$`2018 Konsumquote` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
...
HH_konsum_EF82 <- evs13 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF82/EF89*100) %>% 
  summarise(`2013 absolut` = round(wtd.mean(EF82/3, EF107), digits=1), 
            `2013 Konsumquote` = round(wtd.mean(consum_share, EF107),digits=1))
HH_konsum_EF82$`2018 absolut` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF82/EF89*100) %>% 
  summarise(`2018 absolut` = round(wtd.mean(EF82/3, EF107), digits=1), 
            `2018 Konsumquote` = round(wtd.mean(consum_share, EF107))) %>%
  pull(`2018 absolut`)
HH_konsum_EF82$`2018 Konsumquote` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
...
HH_konsum_EF85 <- evs13 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF85/EF89*100) %>% 
  summarise(`2013 absolut` = round(wtd.mean(EF85/3, EF107), digits=1), 
            `2013 Konsumquote` = round(wtd.mean(consum_share, EF107),digits=1))
HH_konsum_EF85$`2018 absolut` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
  mutate(consum_share = EF85/EF89*100) %>% 
  summarise(`2018 absolut` = round(wtd.mean(EF85/3, EF107), digits=1), 
            `2018 Konsumquote` = round(wtd.mean(consum_share, EF107))) %>%
  pull(`2018 absolut`)
HH_konsum_EF85$`2018 Konsumquote` <- evs18 %>% 
  group_by(milo_hh) %>% 
  filter(
    EF62 >= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[2] &
      EF62 <= wtd.quantile(EF62, EF107, probs=seq(0,1,0.01))[100]) %>%
